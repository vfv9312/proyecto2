<div class="mb-4 rounded-lg shadow-xl dark:-gray-600 h-96">
    <!-- Start block -->
            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div
                    ...
                    <div
                        ...
                        <button type="button"
                            class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="flex items-center justify-end w-40 py-2">
                                    <img class="h-40 " src="https://via.placeholder.com/150" alt="">
                                </td>
                                <td>
                                ...
                                <td>
                                    <label class="inline-flex items-center cursor-pointer me-5">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-900 ms-3 dark:text-gray-300">Estatus</span>
                                    </label>
                                </td>
                            </tr>
