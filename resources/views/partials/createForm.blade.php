<div class="h-full mb-4 rounded-lg shadow-xl dark:-gray-600">
    <div class="container px-4 py-8 mx-auto">
        <div class="mx-auto overflow-hidden bg-white rounded-lg dark:bg-gray-700 ">
            <div class="px-6 py-4">
                <h2 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white">Formulario para crear</h2>
                <p class="mb-4 text-gray-600 dark:text-white">Crear nuevo item</p>
                <form>
                    <div class="mb-4">
                        <label for="nombre" class="block mb-2 font-semibold text-gray-700 dark:text-white">Nombre</label>
                    ...
                    <div class="flex items-center justify-center px-6 py-4 mt-5 bg-white dark:bg-gray-700">
                        ...
                        <div class="flex flex-col ">
                            <p class="text-center text-gray-600 dark:text-white">Imagen de 150 x 150 no mayor a 2mb</p>
