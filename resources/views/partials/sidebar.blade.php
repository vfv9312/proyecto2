                ...
                <ul class="space-y-1 font-medium">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-xl dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group transition-all duration-300">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap group-hover:tracking-wide transition-all duration-300">En desarrollo </span>
                            <span class="inline-flex items-center justify-center px-2 text-xs font-semibold text-gray-600 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">Inactivo</span>
                        </a>
                    </li>
