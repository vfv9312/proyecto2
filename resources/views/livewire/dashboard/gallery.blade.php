                    ...
                    <form class="flex flex-col items-center">
                        <label class="w-full flex flex-col items-center px-4 py-6 bg-white rounded-xl shadow-inner border-2 border-dashed border-gray-300 cursor-pointer hover:bg-gray-50 hover:border-olive transition relative overflow-hidden">
                            <div wire:loading.remove wire:target="photo" class="flex flex-col items-center">
                                ...
                                <span class="text-sm text-gray-500 font-medium">Haz clic aquí para seleccionar tu foto</span>
                            </div>
                            
                            <div wire:loading wire:target="photo" class="text-sm text-olive flex flex-col items-center">
                                <svg class="animate-spin h-8 w-8 text-olive mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                Subiendo foto...
                            </div>
