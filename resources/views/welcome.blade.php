...
<body class="antialiased">
    <div
        ...
        {{-- <div class="p-6 mx-auto text-white max-w-7xl lg:p-8"> --}}
            @yield('content')
    ...
    <script>
        ...
        document.addEventListener('keypress', function(event) {
            ...
            // Agregar el valor de la tecla al campo de texto
            // document.getElementById('barcodeInput').value += keyPressed;

            // Si la tecla presionada es 'Enter', se ha completado la lectura del código de barras
            if (keyPressed === 'Enter') {
                var barcodeValue = document.getElementById('barcodeInput').value;
                console.log('Código de barras leído:', barcodeValue);

                // Puedes hacer lo que necesites con el código de barras leído aquí
                // Por ejemplo, enviarlo a un servidor para procesamiento adicional
                // O mostrarlo en la página web de alguna manera
            }
        });
    </script>
    @livewireScripts
