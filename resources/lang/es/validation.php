...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'category_data' => 'tipo de empleado',
        'sales_point_id' => 'punto de venta',
        'address' => 'domicilio',
        'name' => 'nombre',
        'vehicle_registration' => '# registro',
        'policy' => '# poliza',
        'economic_number' => '# economico',
        'vehicle_type_id' => 'tipo de vehiculo',
        'route.0.departure_time' => 'hora de partida',
        'number_seats' => '# asientos',
        'price' => 'precio',
        'tour_type_id' => 'tipo de Viaje',
        'vehicle_id' => 'vehiculo',
        'trip_id' => 'ruta',
        'date_start' => 'fecha de inicio',
        'date_end' => 'fecha de culminación',
        'employee_driver_id' => 'conductor',
        'employee_assistant_id' => 'auxiliar',
        'unit' => 'unidad',
        'car_brand' => 'marca',
        'car_model' => 'modelo',
        'description' => 'descripcion',
        'passenger_capacity' => '# asientos',
        'single_trip_price' => 'precio por viaje',
        'round_trip_price' => 'precio de viaje redondo',
        'full_name' => 'nombre completo',
        'ticket_type_id' => 'tipo de boleto',
        'status_id' => 'status',
        'number' => '# asiento',
        'tour_id' => 'viaje de ida',
        'number_two' => '# asiento',
        'tour_id_two' => 'viaje de vuelta',
        'amount' => 'monto',
        'description' => 'descripcion',
        'price_adjustment_type_id' => 'tipo de descuento',
        'platform_id' => 'terminal',
        'price_adjustment' => 'descuento',
        'key' => 'clave',
        'expenses_type_id' =>'tipo de gastos',
        'subject' => 'asunto',
        'text' => 'descripcion',
        'password' => 'contraseña',
        'password_confirmation' => 'confirmar contraseña',
        'license_plate' => '# placa',
        'platformStartOne' => '¿Donde Desea Abordar?',
        'platformEndOne' => '¿Donde Desea Bajar?',
        'platformStartTwo' => '¿Donde Desea Abordar?',
        'platformEndTwo' => '¿Donde Desea Bajar?',
    ],
